          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="hidden md:flex items-center space-x-1">
                <button
                  onClick={() => router.push("/")}
                  className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-lg transition-all duration-200 hover:cursor-pointer">
                ...
                {(user || departmentMember) && (
                  <button
                    ...
                    className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-blue-700 hover:bg-blue-50 rounded-lg transition-all duration-200 hover:cursor-pointer">
                ...
                {user ? (
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <button
                      onClick={handleLogout}
                      className="flex items-center space-x-2 px-3 py-2 text-sm font-medium text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-all duration-200 hover:cursor-pointer">
                      <LogOut className="w-4 h-4" />
                      <span className="hidden sm:inline">
                        {t("logout") || "Logout"}
                      </span>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <button
                      ...
                      className="px-4 py-2 text-sm font-medium bg-blue-600 text-white hover:bg-blue-700 rounded-lg shadow-sm transition-all duration-200 hover:shadow-md hover:cursor-pointer">
                      <span className="hidden sm:inline">
                    ...
                    <button
                      ...
                      className="px-4 py-2 text-sm font-medium bg-purple-600 text-white hover:bg-purple-700 rounded-lg shadow-sm transition-all duration-200 hover:shadow-md hover:cursor-pointer">
              ...
              <button
                ...
                className="flex items-center space-x-2 px-3 py-2 text-sm font-medium text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-lg transition-all duration-200 hover:cursor-pointer">
              ...
              <div className="px-4 py-3 space-y-1">
                ...
                {(user || departmentMember) && (
                  <button
                    onClick={() => {
                      router.push(
                        user ? "/dashboard" : "/department/dashboard"
                      );
                      setIsMobileMenuOpen(false);
                    }}
