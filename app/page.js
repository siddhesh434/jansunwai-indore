          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-10 max-w-2xl">
                {t("heroDescription") ||
                  "We are working on improving our municipal complaint management system. Track the most urgent issues and see how we're addressing them in real-time."}
              </p>

              <div className="flex flex-wrap gap-4">
                <button
                  onClick={() => router.push("/login")}
                  className="flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3.5 rounded-lg transition-colors font-medium hover:cursor-pointer">
                  <span>{t("citizenLogin")}</span>
                  <ArrowRight className="w-4 h-4" />
                </button>
                <button
                  onClick={() => router.push("/department/login")}
                  className="flex items-center justify-center space-x-2 bg-white border border-blue-600 text-blue-600 hover:bg-blue-50 px-6 py-3.5 rounded-lg transition-colors font-medium hover:cursor-pointer">
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                ...
                {loading ? (
                          ...
                          <div className="flex items-center space-x-2">
                            <div
                              className={`w-3 h-3 rounded-full ${
                                query.urgencyScore >= 4
                                  ? "bg-red-500"
                                  : query.urgencyScore >= 3
                                  ? "bg-orange-500"
                                  : "bg-yellow-500"
                              }`}></div>
                            <span className="text-sm font-medium text-gray-600">
                              {query.urgencyLabel ||
                                `Score: ${query.urgencyScore}`}
                            </span>
                          </div>
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500">
                      No urgent queries at the moment
                    </p>
                    <p className="text-sm text-gray-400 mt-1">
                      We&apos;re working on improving our system
                    </p>
                  </div>
                )}
                ...
                <div className="mt-6 pt-4 border-t border-gray-200">
                  <button
                    onClick={() => router.push("/login")}
                    className="w-full flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors font-medium text-sm hover:cursor-pointer">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-red-700 text-sm mt-1">
                      The application cannot connect to the database. Please
                      check your MONGOURL environment variable.
                    </p>
                  </div>
                </div>
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              {t("aboutUsDescription") ||
                "Discover how our AI-powered system revolutionizes municipal complaint management for the citizens of Indore."}
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "AI-Powered",
                description:
                  "Advanced artificial intelligence for smart complaint routing and analysis",
              },
              {
                icon: "🏢",
                title: "Department Specific",
                description:
                  "Specialized dashboards for each municipal department",
              },
              {
                icon: "🌍",
                title: "Multilingual",
